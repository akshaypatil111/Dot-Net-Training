...
export class AdminComponent implements OnInit {
  ...
  AddProduct()
  {
    ...
    var admindto={
      ...
      category:Number(this.adminprod.category),
    ...
    this.httpc.post("https://localhost:44321/api/Product",admindto).subscribe(res=>this.PostSuccess(res),res=>this.PostError(res));
